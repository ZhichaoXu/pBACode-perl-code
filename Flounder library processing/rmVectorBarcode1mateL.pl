...
my ($MERGE, $NOHINDIII, $QUALITY,  $QUALITYTRIM, $TRIMLEN, $VAR) = ('32.notCombined_', 'nosite', $cf{"SQ_threshold"}, $cf{"SQG_threshold"}, $cf{"flag_length"}, $cf{"BAC_variance"});
my @MINILEN = (10, 20);

...
my ($MERGE, $MINILEN, $NOHINDIII, $QUALITY,  $QUALITYTRIM, $TRIMLEN, $VAR) = ('32.notCombined_', 20, 'noHindIII', $cf{"SQ_threshold"}, $cf{"SQG_threshold"}, $cf{"flag_length"}, $cf{"BAC_variance"});
